...
namespace Dreamteck.Splines
{
    ...
    public class SplineFollower : SplineTracer
    {
        ...
        public double lastClippedPercent = -1.0;
        ...
        public void SetPercentNew(double percent, bool checkTriggers = false, bool handleJuncitons = false)
        {
            base.SetPercentNew(percent, _result, checkTriggers, handleJuncitons);
