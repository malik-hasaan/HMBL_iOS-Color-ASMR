...
namespace Dreamteck.Splines
{
    public class SplineTracer : SplineUser
    {
        ...
        public virtual void SetPercentNew(double percent, SplineSample resultTemp, bool checkTriggers = false, bool handleJunctions = false)
        {
            _result = resultTemp;
        ...
        public virtual Transform GetTransform2()
        {
            return transform;
        }
        ...
        protected void ApplyMotionNew()
        {
            _finalResult = _result;

            ModifySample(_result, _result);
